...
class HeartbeatResponseWorkerhandler extends MessageAbstract
{
    /**
     * Creates a HeartbeatResponseWorkerHandler message from the Message.
     *
     * @param \AlphaRPC\Common\Socket\Message $msg
     *
     * @return HeartbeatResponseWorkerhandler
     */
