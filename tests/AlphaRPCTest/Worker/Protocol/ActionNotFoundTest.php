...
use AlphaRPC\Worker\Protocol\ActionNotFound as ProtocolMessage;

class ActionNotFoundTest extends \PHPUnit_Framework_TestCase
{
    public function testRoundtrip()
    {
        $pm = new ProtocolMessage('12345', 'service');
